...
const columns: GridColDef[] = [
  ...
  { field: 'debtToEarningsAnnualRate', headerName: 'Debt-To-Earnings Annual Rate', width: 150 },
  { field: 'meanAnnualEarningsFromSsa', headerName: 'Mean Annual Earnings From SSA', width: 150 },
  { field: 'medianAnnualEarningsfromSsa', headerName: 'Median Annual Earnings from SSA', width: 150 },
];
